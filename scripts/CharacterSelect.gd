...
func _physics_process(delta: float) -> void:
	...
	_update_player(1, "p1_move_left", "p1_move_right", "p1_high", p1_cursor, p1_marker, p1_badge)
	_update_player(2, "p2_move_left", "p2_move_right", "p2_high", p2_cursor, p2_marker, p2_badge)
	_update_status()
	banner_time += delta
	_update_banner()
